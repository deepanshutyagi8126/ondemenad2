...
$(document).on('click','.unshow',function(){
    if($('.unshow').hasClass('showCommon')){
        $('.unshow').removeClass('showCommon');
        $('.unshow i').removeClass('fa fa-eye-slash').addClass('fa fa-eye');
        $('.passShow').attr('type','text');
    }
    else{
        $('.unshow').addClass('showCommon');
        $('.unshow i').removeClass('fa fa-eye').addClass('fa fa-eye-slash'); 
